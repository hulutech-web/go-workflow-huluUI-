<template>
  <div class="range-between">
    <span class="range-group">
      <ConditionRangeBetweenNumber v-model:value="num1" />
      <ConditionRangeBetweenSelect v-model:value="val1" />
    </span>
    <span class="range-group-label">{{ data.paramLabel }}</span>
    <span class="range-group">
      <ConditionRangeBetweenSelect v-model:value="val2" />
      <ConditionRangeBetweenNumber v-model:value="num2" />
    </span>
  </div>
</template>
<script>
import ConditionRangeBetweenSelect from './condition-range-between-select.vue'
import ConditionRangeBetweenNumber from './condition-range-between-number.vue'
export default {
